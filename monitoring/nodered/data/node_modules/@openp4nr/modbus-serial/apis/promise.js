...
const addPromiseAPI = function(Modbus) {
    ...
    cl.readCoils_deformedReadEnabled = _convert(cl.writeFC1_deformedReadEnabled);
    cl.readDiscreteInputs = _convert(cl.writeFC2);
    cl.readDiscreteInputs_deformedReadEnabled = _convert(cl.writeFC2_deformedReadEnabled);
    cl.readHoldingRegisters_deformedReadEnabled = _convert(cl.writeFC3_deformedReadEnabled);
    ...
    cl.readInputRegisters_deformedReadEnabled = _convert(cl.writeFC4_deformedReadEnabled);
