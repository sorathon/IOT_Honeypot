...
--> <script type='text/javascript'> RED.nodes.registerType('modbus-getter', {
    ...
    defaults: {
      ...
      enableDeformedMessages: {value: false, required: false},
...
style='width:160px'> <i class='fa fa-power-off'></i> <span data-i18n='modbus-contrib.label.delayOnStart'></span></label>
 <input type='checkbox' id='node-input-delayOnStart' style='width:40px'> </div> <div class='form-row' 
...
</strong> </p><p>Output 1: data Array (PDU), modbus response Buffer, input message</p> <p>
