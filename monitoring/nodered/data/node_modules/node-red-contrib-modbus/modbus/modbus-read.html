...
--> <script type='text/javascript'> RED.nodes.registerType('modbus-read', {
    ...
    defaults: {
      ...
      enableDeformedMessages: { value: false },
...
id='node-input-startDelayTime' placeholder='10' style='width:80px'> </div> <div class='form-row' 
id='node-enabledeformedmessages'> <label for='node-input-enableDeformedMessages' style='width:160px'><span 
data-i18n='modbus-contrib.label.enableDeformedMessages'></span></label> <input type='checkbox' 
id='node-input-enableDeformedMessages' style='width:40px'> </div> <div class='form-row'> <label for='node-input-server'>
<i class='icon-globe'></i> <span data-i18n='modbus-contrib.label.server'></span></label> <input type='text' 
